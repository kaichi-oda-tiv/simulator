...
namespace Simulator.Sensors
{
    static class DefaultSensors
    {
        ...
        public static readonly string TestCase = "[" + string.Join(",",
            @"{""type"": ""CAN-Bus"", ""name"": ""CAN Bus"",
                ""params"": {""Frequency"": 10, ""Topic"": ""/apollo/canbus/chassis""},
                ""transform"": {""x"": 0, ""y"": 0, ""z"": 0, ""pitch"": 0, ""yaw"": 0, ""roll"": 0}}",
            ...
            @"{""type"": ""Video Recording"", ""name"": ""Video Recording Sensor"",
                ""transform"": {""x"": 0, ""y"": 10.0, ""z"": -10.0, ""pitch"": 30, ""yaw"": 0, ""roll"": 0} }",

            @"{""type"": ""CheckControl"", ""name"": ""Check Control Sensor"",
                ""params"": {""Topic"": ""/apollo/control""} }",

            @"{""type"": ""Analysis"", ""name"": ""Analysis Sensor""}"
        ) + "]";
    }
}
